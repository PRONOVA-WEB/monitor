                ...
                <div class="form-row">
                    <fieldset class="form-group col-12 col-sm-6 col-lg-3">
                        ...
                        <select name="status" id="for_status" class="form-control">
                            ...
                            <option
                                value="Hospitalizado Básico" {{ ($patient->status == 'Hospitalizado Básico')?'selected':'' }}>
                                Hospitalizado Básico
                            </option>
                            <option
                                value="Hospitalizado Medio" {{ ($patient->status == 'Hospitalizado Medio')?'selected':'' }}>
                                Hospitalizado Medio
                            </option>
                            <option
                                value="Hospitalizado UTI" {{ ($patient->status == 'Hospitalizado UTI')?'selected':'' }}>
                                Hospitalizado UTI
                            </option>
                            <option
                                value="Hospitalizado UCI" {{ ($patient->status == 'Hospitalizado UCI')?'selected':'' }}>
                                Hospitalizado UCI
                            </option>
                            <option
                                value="Hospitalizado UCI (Ventilador)" {{ ($patient->status == 'Hospitalizado UCI (Ventilador)')?'selected':'' }}>
        ...
        <div class="card-body">
            ...
            @canany(['SanitaryResidence: survey','Developer','Patient: tracing'])
                <a class="btn btn-primary btn-sm"
                   href="{{ route('patients.contacts.create', ['search'=>'search_false', 'id' => $patient->id]) }}">
                        ...
                        @can('Patient: tracing')
                            <td>
                                <a class="btn btn-danger btn-sm"
                                   href="{{ route('patients.contacts.destroy', $contact) }}"
                                   onclick="return confirm('¿Está seguro que desea eliminar el contacto estrecho con el paciente {{$contact->patient->fullName}}?' )">
                            ...
                            @if($admission->status)
                                <td class="text-center align-middle">
                                    <a class="btn btn-warning btn-sm"
                                       href="{{ route('sanitary_residences.admission.show', $admission) }}">
                                        <i class="fas fa-poll-h"></i> Ver Encuesta (tiene resultado final)
                                    </a></td>
                            @else

                                <td class="text-center align-middle"><a class="btn btn-success btn-sm"
                                                                        href="{{ route('sanitary_residences.admission.edit', $admission) }}">
